...
const Footer = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="bg-[#fafafa] px-[30px] pb-[57px] pt-[36px] text-black md:px-[70px] md:pb-[68px] md:pt-[43px] lg:px-[157px] lg:pb-[80px] lg:pt-[50px] xl:px-[180px] xl:pb-[91px] xl:pt-[58px] 2xl:px-[225px] 2xl:pb-[114px] 2xl:pt-[73px]"
      >
