    ...
    <div className="flex rounded-[10px] bg-[#F9F9F9] px-[10px] py-[8px] text-[#000] md:px-[12px] md:py-[9px] lg:px-[14px] lg:py-[11px] xl:px-[16px] xl:py-[12px] 2xl:px-[20px] 2xl:py-[15px]">
      <div className="relative flex items-center gap-x-[10px]">
        ...
        {showTooltipServiceRegion && (
          <div className="absolute left-[130px] top-[-50px] w-[470px] rounded-[10px] bg-[#000] px-[13px] py-[10px] text-[8px] font-medium text-white md:left-[162px] md:top-[-60px] md:px-[15px] md:py-[12px] md:text-[9px] lg:left-[189px] lg:top-[-70px] lg:px-[17px] lg:py-[14px] lg:text-[11px] lg:!leading-[19px] xl:left-[216px] xl:top-[-80px] xl:px-[20px] xl:py-[16px] xl:text-[13px] 2xl:left-[270px] 2xl:top-[-100px] 2xl:px-[25px] 2xl:py-[20px] 2xl:text-[16px]">
