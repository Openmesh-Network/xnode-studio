...
const YourCore = ({ ...data }: ModalProps) => {
  ...
  return (
    <div className="relative flex rounded-[10px] bg-[#F9F9F9] px-[10px] py-[8px] text-black md:px-[12px] md:py-[9px] lg:px-[14px] lg:py-[11px] xl:px-[16px] xl:py-[12px] xl:pb-[40px] 2xl:px-[20px] 2xl:py-[15px] 2xl:pb-[50px]">
              ...
              <div key={index}>
                <div className="flex items-center gap-x-[4px]">
                  ...
                  <div className="relative text-[9px] font-bold text-[#313131] md:text-[10.8px] lg:text-[12.6px] xl:text-[14.4px] 2xl:text-[18px]">
                    ...
                    />
                    <img
                      src={`${prefix}/images/reviewYourBuild/third.svg`}
                      alt="image"
